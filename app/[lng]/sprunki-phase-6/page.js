...
async function Page({params}){
	...
	return (
		<div className="home py-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<iframe src={`https://iframegame.com/embed/sprunki-phase-6/index.html`} frameBorder="0" className="w-[1220px] h-[70vh]"/>
			{/*<iframe src={`/games/sprunki-phase-5.html`} frameBorder="0" className="w-[1220px] h-[70vh]"/>*/}
			{/*游戏列表*/}
			<GameList/>
			{/*Features*/}
